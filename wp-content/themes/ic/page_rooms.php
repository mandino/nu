...
<div class="fullpic">
	...
	<div class="slide-header">
		<a class="button"  onclick="_gaq.push(['_link', this.href]); ga('send', 'event', 'Reserve', 'Reservation-button-banner', 'Reserve Now');return false;" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
	</div>
