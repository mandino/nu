...
<div class="fullpic">
	...
	<div class="slide-header">
		<a onclick="ga('send', 'event', 'Reserve', 'Reservation-button-banner', 'Reserve Now');" class="button" target="_blank" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
	</div>
	...
	<div id="page-content" class="section">
		...
		<div class="container">
			...
			<div class="sidebar fr">
				...
				<a class="button" target="_blank" onclick="ga('send', 'event', 'Reserve', 'Reservation-button-sidebar', 'Reserve Now');" href="<?php if(get_post_meta ($post->ID, 'cebo_booklink', true)) { echo get_post_meta ($post->ID, 'cebo_booklink', true); } else { echo get_option('cebo_genbooklink'); } ?>"><?php _e('RESERVE NOW', 'cebolang'); ?></a>
