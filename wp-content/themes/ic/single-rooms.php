						...
						<ul>
							<?php
                                ...
                                foreach ($attachments as $attachment) {
                                    ...
                                    $image_list .= '<li><a rel="prettyPhoto[gal]" href=" ' . str_replace('-150x150','',$image_url[0]) . ' "><img src="' . str_replace('-150x150','',$image_url[0]) . '"  alt="' . $image_alt . '" style="width: 80px; height: 80px;" /></li></a>';
                                }
                                echo $image_list;
                            ?>
						</ul>
