...
<!--			<div class="section-header" style="border-top: 1px solid #ddd; margin-top: 60px; margin-bottom: 0; float: none; text-align: center;">
				...
				<div class="fl" style="float: none; text-align: center; padding: 20px 0;">
					...
					<h2 class="section-title fr" style="text-align: center; float: none; text-transform: uppercase;"><?php _e('More Perspective Rooms', 'cebolang'); ?></h2>
	...
	<!--	<div class='iosSlider'>
			...
			<div class='slider'>
				...
				<?php query_posts(array('post_type' => 'perspective_room', 'posts_per_page' => -1,  'post__not_in' => array($post->ID))); if(have_posts()) : while(have_posts()) : the_post(); ?>
